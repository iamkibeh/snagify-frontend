...
const ApplicationForm = ({
  ...
  const { createApplication, updateApplication, isLoading } = useContext(
  ...
  return (
    <>
      ...
      <div className='bg-white p-8 rounded-xl shadow-md w-[60%] max-w-4xl min-w-[300px] h-[75%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-auto z-50'>
        {isLoading && (
          <div className='inset-0 bg-black opacity-70 flex items-center justify-center w-full h-full absolute top-0 left-0'>
            <Loader />
          </div>
        )}
